...
import main.java.VolatiliaOGL.particles.Particle;
import main.java.VolatiliaOGL.particles.ParticleTexture;
import main.java.VolatiliaOGL.shaders.particle.ParticleShader;
...
public class ParticleRenderer
{
	...
	public void render(Map<ParticleTexture, List<Particle>> particles, Camera camera)
	{
		...
		for(ParticleTexture texture : particles.keySet())
		{
			...
			{
				this.updateModelViewMatrix(particle.getPosition(), particle.getRotation(), particle.getScale(), viewMatrix, vboData);
				this.updateTextCoordInfo(particle, vboData);
			}
			Loader.INSTANCE.updateVbo(vbo, vboData, buffer);
	...
	private void updateTextCoordInfo(Particle particle, float data[])
	{
