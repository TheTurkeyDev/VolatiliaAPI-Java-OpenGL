...
public class Fbo
{
	...
	public void resolveToFbo(Fbo outFbo)
	{
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, outFbo.width, outFbo.height, GL11.GL_COLOR_BUFFER_BIT | GL11.GL_DEPTH_BUFFER_BIT, GL11.GL_NEAREST);
	...
	/**
	 * Creates a new frame buffer object and sets the buffer to which drawing will occur - colour attachment 0. This is the attachment where the colour buffer texture is.
	 * 
	 */
