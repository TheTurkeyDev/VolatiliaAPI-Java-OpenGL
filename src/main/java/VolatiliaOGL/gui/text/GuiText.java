...
public class GuiText
{
	 ...
	 * @param position
	 *            - the position on the screen where the top left corner of the text should be rendered. The top left corner of the screen is (0, 0) and the bottom right is (1, 1).
	 * @param maxLineLength
