...
{
	/**
	 * Sorts a list of particles so that the particles with the highest distance from the camera are first, and the particles with the shortest distance are last.
	 * 
	 * @param list
